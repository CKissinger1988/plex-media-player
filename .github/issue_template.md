...
This repository is only for SpartanAI-Media (SAM). Please do not open issues related to other Plex clients (Roku, Apple TV, etc) or Plex Media Server.
...
Each filed issue must please:
  ...
  - be accompanied by _clean_ logs.
    - SAM logs can be found here: https://support.plex.tv/articles/207338748-spartanai-media-logs/
