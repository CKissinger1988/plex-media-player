# Contributing to SpartanAI-Media

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to SpartanAI-Media.

#### 1 - Read the Plex CLA

Before commiting, you will need to read the CLA which can be found in our [wiki](https://github.com/plexinc/spartanai-media/wiki/Contributor-License-Agreement#individual-agreement)
...
There are a few things you should verify before submitting a PR to SpartanAI-Media.
 ...
 - Take time to write a clear and understandable commit message description. Most of the time the commit title is not enough to describe the patch and why it's required. Think of the fact that SpartanAI-Media is running on multiple platforms and that there are other context than your.
